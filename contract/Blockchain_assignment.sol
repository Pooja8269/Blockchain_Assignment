...
contract Blockchain_assignment is ERC20Interface{
   ...
   // mapping(address => userStruct) private users;
    ...
    function requestTokenAdmin(address _requestFrom,
    ...
    function getRequestList(uint _index) public view returns(uint, address, uint, bool){
